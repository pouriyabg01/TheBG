<div class="handheld-toolbar">
    ...
    <div class="d-table table-layout-fixed w-100"><a class="d-table-cell handheld-toolbar-item" href="{{ route('account-wishlist') }}"><span class="handheld-toolbar-icon"><i class="headerWishlistIcon @auth('customer'){{ $customer->wishlist()->exists() ?  'ci-heart-filled' : 'ci-heart'}}@endauth ci-heart"></i></span><span class="handheld-toolbar-label">Wishlist</span></a><a class="d-table-cell handheld-toolbar-item" href="javascript:void(0)" data-bs-toggle="collapse" data-bs-target="#navbarCollapse" onclick="window.scrollTo(0, 0)"><span class="handheld-toolbar-icon"><i class="ci-menu"></i></span><span class="handheld-toolbar-label">Menu</span></a><a class="d-table-cell handheld-toolbar-item" href="shop-cart.html"><span class="handheld-toolbar-icon"><i class="ci-cart"></i>@auth('customer')<span class="badge bg-primary rounded-pill ms-1 cartItemCount">{{ $customer->cartItemCount() }}</span>@endauth</span><span class="handheld-toolbar-label" id="footerCartItemSubTotal">@auth('customer'){{ $customer->cartItemSubTotal() }}@endauth</span></a></div>
</div>
